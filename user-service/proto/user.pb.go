...
// Message definition for a simple User
type User struct {
...
type CreateUserRequest struct {
	...
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Email       string `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	RawPassword string `protobuf:"bytes,4,opt,name=rawPassword,proto3" json:"rawPassword,omitempty"`
}
...
func (x *CreateUserRequest) GetRawPassword() string {
	if x != nil {
...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x68, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x68, 0x61,
	0x73, 0x68, 0x65, 0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x6f, 0x0a, 0x11,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x20, 0x0a, 0x0b, 0x72,
	0x61, 0x77, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x72, 0x61, 0x77, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x4e, 0x0a,
	...
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x80, 0x01, 0x0a,
...
var file_user_proto_depIdxs = []int32{
	...
	3, // 1: user.UserService.GetUser:input_type -> user.UserRequest
	1, // 2: user.UserService.CreateUser:input_type -> user.CreateUserRequest
	4, // 3: user.UserService.GetUser:output_type -> user.UserResponse
